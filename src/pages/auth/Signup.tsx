...
export default function Signup() {
    ...
    const handleSignup = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            // Instead of full signup yet, go to step 2 or verification
        ...
        <div className="w-full max-w-sm mx-auto">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
                <div className="space-y-2">
                    ...
                    <Input id="fullName" placeholder="Rohan Sharma" required />
                </div>

                <div className="space-y-2">
                    <Label htmlFor="email">Work Email</Label>
                    <Input id="email" type="email" placeholder="you@yourbusiness.com" required />
                ...
                <Button type="button" variant="outline" className="w-full bg-white text-gray-700 hover:bg-gray-50 border-gray-300">
